...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_g90vrg6', 'template_ke9vp1k', formRef.current, 'tEGTumB09JA__-ZJb')
      .then((result) => {
        setSuccess(true)
      }, (error) => {
        setError(true)
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>djdev2302@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>
            B-103 Yogeshwar Residncy Near ,
            <br />
            Austosh Tenament NEW Rto Road,
            <br />
            Ahmedabad 382415.
          </span>
        </motion.div>
